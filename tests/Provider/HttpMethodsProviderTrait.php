...
trait HttpMethodsProviderTrait
{
    ...
    {
        return [
            ['method' => 'get', 'httpMethod' => Route::GET],
            ['method' => 'post', 'httpMethod' => Route::POST],
            ['method' => 'put', 'httpMethod' => Route::PUT],
            ['method' => 'delete', 'httpMethod' => Route::DELETE],
            ['method' => 'head', 'httpMethod' => Route::HEAD],
            ['method' => 'options', 'httpMethod' => Route::OPTIONS],
            ['method' => 'patch', 'httpMethod' => Route::PATCH],
            ['method' => 'any', 'httpMethod' => Route::GET],
            ['method' => 'any', 'httpMethod' => Route::POST],
            ['method' => 'any', 'httpMethod' => Route::PUT],
            ['method' => 'any', 'httpMethod' => Route::DELETE]
        ];
    }
}
